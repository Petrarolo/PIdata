...
setup(
  ...
  download_url = 'https://github.com/Petrarolo/PIdata/archive/0.2.2.tar.gz',    # I explain this later on
  keywords = ['OSI', 'PI', 'Connector', 'Historian', 'Process', 'Control', 'Automation', 'Engineering'],   # Keywords that define your package best
